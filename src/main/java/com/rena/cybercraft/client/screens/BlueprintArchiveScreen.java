...
public class BlueprintArchiveScreen extends ContainerScreen<BlueprintArchiveContainer> {
    ...
    public static final ResourceLocation TEXTURE = Cybercraft.modLoc("textures/gui/blueprint_archive.png");

    public BlueprintArchiveScreen(BlueprintArchiveContainer p_i51105_1_, PlayerInventory p_i51105_2_, ITextComponent p_i51105_3_) {
