...
public class ArmUpgradeItem extends CybercraftItem{
    ...
    public NonNullList<NonNullList<ItemStack>> required(ItemStack stack) {
        ...
        l2.add(ItemInit.LIMB_LEFT.get().getCachedStack(ItemCyberlimb.META_LEFT_CYBER_ARM));
        l2.add(ItemInit.LIMB_RIGHT.get().getCachedStack(ItemCyberlimb.META_RIGHT_CYBER_ARM));
        l1.add(l2);
        return l1;
    }
