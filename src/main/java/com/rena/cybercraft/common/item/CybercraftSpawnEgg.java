...
public class CybercraftSpawnEgg extends SpawnEggItem {

    protected static final List<CybercraftSpawnEgg> EGGS_TO_ADD = new ArrayList<>();
    ...
    public CybercraftSpawnEgg(final RegistryObject<? extends EntityType<?>> entity, final int primaryColor,
