...
import com.rena.cyberware.common.item.CybercraftArmorMaterial;
import com.rena.cyberware.common.item.CybercraftItemAmor;
...
public class ItemInit {
    ...
    public static final RegistryObject<Item> JACKET = ITEMS.register("jacket",
            ()-> new ArmorItem(CybercraftArmorMaterial.JACKET, EquipmentSlotType.CHEST, new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    public static final RegistryObject<Item> SHADES = ITEMS.register("shades",
            ()-> new ArmorItem(CybercraftArmorMaterial.SHADES, EquipmentSlotType.HEAD, new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    public static final RegistryObject<Item> SHADES2 = ITEMS.register("shades2",
            ()-> new ArmorItem(CybercraftArmorMaterial.SHADES2, EquipmentSlotType.HEAD, new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    public static final RegistryObject<Item> TRENCHCOAT = ITEMS.register("trenchcoat",
            ()-> new CybercraftItemAmor(CybercraftArmorMaterial.TRENCHCOAT, EquipmentSlotType.CHEST, new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));

    //Weapon
    public static final RegistryObject<Item> KATANA = ITEMS.register("katana",
            ()-> new SwordItem(ItemTier.IRON, 4, -2.5F, new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));


    //Eye
    public static final RegistryObject<Item> EYES = ITEMS.register("body_part_eyes",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    public static final RegistryObject<Item> EYES_UPGRADES = ITEMS.register("eye_upgrades_hudlens",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    ...
    public static final RegistryObject<Item> CYBER_EYES = ITEMS.register("cybereyes",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    public static final RegistryObject<Item> CYBER_EYES_SCAVENGED = ITEMS.register("cybereyes_scavenged",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    ...
    //Muscle
    public static final RegistryObject<Item> MUSCLE = ITEMS.register("body_part_muscles",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    ...
    //Hand
    public static final RegistryObject<Item> HAND_UPGRADES_CLAWS = ITEMS.register("hand_upgrades_claws",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    ...
    public static final RegistryObject<Item> CYBER_LEG_RIGHT_SCAVENGED = ITEMS.register("cyberlimbs_cyberleg_right_scavenged",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    public static final RegistryObject<Item> LIMB_LEFT = ITEMS.register("cyberlimbs_cyberarm_left",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    ...
    public static final RegistryObject<Item> CREATIVE_BATTERY = ITEMS.register("creative_battery",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    public static final RegistryObject<Item> DENSE_BATTERY = ITEMS.register("dense_battery",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
    ...
    public static final RegistryObject<Item> BLUEPRINT_BLANK = ITEMS.register("blueprint_blank",
            ()-> new Item(new Item.Properties().tab(CybercraftTab.CYBERCRAFT)));
